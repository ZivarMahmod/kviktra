...
export function QuoteForm({ onQuoteCreated, quoteCount }: QuoteFormProps) {
  const [company, setCompany] = useState<Company>({
    name: '', trade: 'VVS', phone: '', org_nr: '', f_skatt: true,
    bankgiro: '', email: '', address: '',
  });
  const [customer, setCustomer] = useState<Customer>({
    name: '', email: '', address: '', pnr: '',
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        const descRes = await fetch('/api/generate-description', {
          ...
          body: JSON.stringify({
            ...
            items: items.filter((i) => i.desc && i.qty > 0 && i.unit > 0),
          }),
        });
        if (descRes.ok) {
      ...
      const quote: Quote = {
        ...
        totals: calcTotals(
          items.filter((i) => i.desc && i.qty > 0 && i.unit > 0),
          vatRate,
          rotEnabled
        ),
        job_notes: jobNotes,
    ...
    <form onSubmit={handleSubmit} className="space-y-5 p-4">
      ...
      <fieldset className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <select
              value={company.trade}
              onChange={(e) => setCompany({ ...company, trade: e.target.value })}
            >
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              onChange={(e) => setCompany({ ...company, org_nr: e.target.value })}
        ...
        <div>
          ...
          <input
            ...
            placeholder="Rörgatan 1, 123 45 Stockholm"
          />
        </div>
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              onChange={(e) => setCompany({ ...company, bankgiro: e.target.value })}
          ...
          <div className="flex items-end gap-2 pb-1">
            <input
              type="checkbox"
              id="fskatt"
              checked={company.f_skatt}
              onChange={(e) => setCompany({ ...company, f_skatt: e.target.checked })}
              className="!w-4 h-4"
            />
      ...
      <fieldset className="space-y-3">
        ...
        <div>
          ...
          <input
            ...
            placeholder="Hemvägen 5, 123 45 Stockholm"
          />
        </div>
      </fieldset>
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Beskriv jobbet kort, t.ex: Byta blandare i kök och badrum, installera ny diskmaskin..."
          rows={3}
        />
      ...
      <div className="card p-3">
        ...
        {rotEnabled && (
          <div className="mt-3">
            ...
            <input
              value={customer.pnr}
              onChange={(e) => setCustomer({ ...customer, pnr: e.target.value })}
